...
const data: ContentItem[] = [
  ...
  {id: 2, title: 'Advanced TypeScript Patterns', type: 'Video', author: 'John Doe', date: '2024-01-20', status: 'Draft'},
  ...
  {id: 6, title: 'CSS Grid Layout Guide', type: 'Article', author: 'Dan Kim', date: '2024-02-12', status: 'Published'},
  {id: 7, title: 'Component Architecture Talk', type: 'Video', author: 'Eve Chen', date: '2024-02-15', status: 'Draft'},
      ...
      <Table<ContentItem>
        ...
        columns={[
          {key: 'title', header: 'Title'},
          {
            ...
            header: 'Type',
            renderCell: (row) => (
              <Badge variant={typeBadgeVariant[row.type] ?? 'neutral'} label={row.type} />
            ),
          },
