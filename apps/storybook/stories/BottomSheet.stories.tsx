        ...
        <BottomSheet
          ...
          <Section padding={4}>
            <VStack gap={3}>
              ...
              <Text type="supporting" color="secondary">
                This sheet opens for keyboard testing. Its body has no controls,
                so keyboard users reach the scroll area itself and continue
                through the content with arrow keys or Page Down.
              </Text>
              <Divider />
