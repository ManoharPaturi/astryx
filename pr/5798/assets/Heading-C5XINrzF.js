const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-CR_IzoW3.js","./preload-helper-CT_b8DTk.js","./react-B7Te67-h.js","./jsx-runtime-DqZldVDK.js","./useTooltip-Dy8oh1Be.js","./ime-C8xVbsSx.js","./padding.stylex-Hr1weLfK.js","./react-dom-Ctsxo5CR.js","./useIsomorphicLayoutEffect-AEBSTB0m.js"])))=>i.map(i=>d[i]);
import{i as e,n as t,s as n,t as r}from"./preload-helper-CT_b8DTk.js";import{t as i}from"./react-B7Te67-h.js";import{I as a,L as o,O as s,k as c}from"./ime-C8xVbsSx.js";import{P as l,t as u}from"./utils-BmscZK5p.js";import{t as d}from"./jsx-runtime-DqZldVDK.js";import{_ as f,a as p,c as m,d as h,f as g,g as _,h as v,i as y,l as b,m as x,n as S,o as C,p as w,r as T,s as E,u as D,v as O}from"./Text-BNMPGNrc.js";import{n as k,t as A}from"./useMergedRefs-C4iC7L_T.js";function j({level:e,type:t,accessibilityLevel:n,color:r=`primary`,display:i=`block`,maxLines:a=0,hasTruncateTooltip:s=!0,wordBreak:u,textWrap:d,justify:h=`start`,hasCapsize:y=!1,hasStrikethrough:S=!1,xstyle:A,className:j,style:I,children:L,ref:R,...z}){let B=F[e],V=n&&n!==e?{"aria-level":n}:{},H=u??(a===1?`break-all`:`break-word`),U=a>0||y?`block`:i,W=p({maxLines:a}),G=typeof s==`string`?s:`above`,K=a>0&&s!==!1&&W.isTruncated,q=(0,M.useRef)(null),J=k(R,W.ref,q),Y=a>1?{WebkitLineClamp:a}:void 0;return(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(B,{ref:J,...l(c(`heading`,{level:e,color:r,...t&&{type:t}}),o(E[T(r)],t?x[t]:w[e],t&&b[t],a===1?_.singleLine:a>1?_.multiLine:D[U],a>0&&O[H],d&&v[d],h!==`start`&&g[h],y&&C.enabled,S&&m.strikethrough,A),j,{...I,...Y}),...V,...z,children:L}),K&&(0,N.jsx)(M.Suspense,{fallback:null,children:(0,N.jsx)(P,{anchorRef:q,content:(0,N.jsx)(`span`,{...o(f.content),children:W.fullText}),placement:G})})]})}var M,N,P,F,I=e((()=>{M=n(i(),1),a(),h(),y(),S(),u(),A(),s(),N=d(),t(),P=(0,M.lazy)(async()=>r(()=>import(`./Tooltip-CR_IzoW3.js`).then(e=>(e.r(),e.n)).then(e=>({default:e.Tooltip})),__vite__mapDeps([0,1,2,3,4,5,6,7,8]),import.meta.url)),F={1:`h1`,2:`h2`,3:`h3`,4:`h4`,5:`h5`,6:`h6`},j.displayName=`Heading`,j.__docgenInfo={description:`Heading - Semantic heading component
