import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{I as r,L as i,O as a,k as o}from"./ime-C8xVbsSx.js";import{P as s,t as c}from"./utils-BmscZK5p.js";import{t as l}from"./jsx-runtime-DqZldVDK.js";function u(){if(typeof navigator>`u`)return!1;let e=`userAgentData`in navigator?navigator.userAgentData:null;if(e&&typeof e==`object`&&`platform`in e){let t=e.platform,n=typeof t==`string`?t.trim():``;if(n!==``&&n.toLowerCase()!==`unknown`)return/mac/i.test(n)}return/Mac|iPhone|iPad|iPod/.test(navigator.platform??``)}var d=e((()=>{}));function f(e,t){return e===`mod`?t?`⌘`:`Ctrl`:b[e]??e.toUpperCase()}function p(e,t){return e===`mod`?t?`Command`:`Control`:x[e]??e.toUpperCase()}function m(){return()=>{}}function h(){return!1}function g({keys:e,ref:t,xstyle:n,className:r,style:a,...c}){let l=(0,_.useSyncExternalStore)(m,u,h),d=e.split(`+`).map(e=>e.trim().toLowerCase()),g=d.map(e=>p(e,l)).join(` + `);return(0,v.jsx)(`span`,{...c,ref:t,role:`img`,"aria-label":g,...s(o(`kbd`),i(y.wrapper,n),r,a),children:d.map(e=>(0,v.jsx)(`kbd`,{"aria-hidden":`true`,className:`astryx3nfvp2 astryx6s0dn4 astryxl56j7k astryx16asifk astryx1grt7ep astryx7a5moj astryxx3sua9 astryx17x4s8c astryxlxy82 astryx1q0q8m5 astryxib2hle astryxv1l7n4 astryx9ynric astryx141an7d astryx1e4wzip astryx1ltkj2j astryx87ps6o`,children:f(e,l)},e))})}var _,v,y,b,x,S=e((()=>{_=t(n(),1),r(),c(),d(),a(),v=l(),y={wrapper:{k1xSpc:`astryx3nfvp2`,kGNEyG:`astryx6s0dn4`,kOIVth:`astryxzye2dw`,kmuXW:`astryx2lah0s`,$$css:!0}},b={ctrl:`⌃`,alt:`⌥`,shift:`⇧`,enter:`↵`,backspace:`⌫`,escape:`Esc`,tab:`⇥`,up:`↑`,down:`↓`,left:`←`,right:`→`,plus:`+`},x={ctrl:`Control`,alt:`Alt`,shift:`Shift`,enter:`Enter`,backspace:`Backspace`,escape:`Escape`,tab:`Tab`,up:`Up arrow`,down:`Down arrow`,left:`Left arrow`,right:`Right arrow`,plus:`Plus`},g.displayName=`Kbd`,g.__docgenInfo={description:`Displays a keyboard shortcut as styled <kbd> elements.
