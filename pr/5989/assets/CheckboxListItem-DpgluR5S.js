import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{O as r,k as i}from"./ime-C8xVbsSx.js";import{P as a,t as o}from"./utils-BmscZK5p.js";import{l as s,t as c}from"./i18n-CXMRQXeB.js";import{t as l}from"./jsx-runtime-DqZldVDK.js";import{n as u}from"./useTooltip-BV-_h7Vm.js";import{n as d,t as f}from"./useDevWarning-UeYTLgfL.js";import{t as p}from"./Tooltip-yBaiyUoR.js";import{n as m,t as h}from"./Field-Dk4xgnh6.js";import{a as g,i as _,n as v,o as y,r as b,s as x}from"./List-9N1CZkKs.js";import{i as S,n as C,r as w,t as T}from"./CheckboxInput-Bi9QkQVr.js";function E({label:e,isLabelHidden:t=!1,description:n,status:r,value:o,onChange:s,changeAction:c,density:l=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:p,isReadOnly:m=!1,children:g,ref:v,width:y,xstyle:b,className:x,style:S,"data-testid":C,...T}){let E=(0,D.useId)(),A=(0,D.useId)(),j=(0,D.useId)(),M=(0,D.useId)(),[,N]=(0,D.useTransition)(),P=o!==void 0,[F,I]=(0,D.useOptimistic)(o??k),[L,R]=(0,D.useOptimistic)(null),z=f&&!!p,B=u({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,D.useCallback)((e,t)=>{s?.(e),c&&N(async()=>{I(e),t!==void 0&&R(t),await c(e)})},[s,c,N,I,R]),H=(0,D.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:m,loadingValue:L}),[P,F,V,f,z,m,L]);return(0,O.jsxs)(h,{...T,ref:v,"data-testid":C,label:e,isLabelHidden:t,description:n,inputID:E,labelID:A,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:r?{type:r.type,message:r.message,messageID:r.message?M:void 0}:void 0,statusVariant:`detached`,width:y,xstyle:b,...a(i(`checkbox-list`),{className:x,style:S}),children:[(0,O.jsx)(w,{value:H,children:(0,O.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":A,"aria-describedby":[n?j:null,r?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,O.jsx)(_,{density:l,hasDividers:d,children:g})})}),z&&B.renderTooltip(p)]})}var D,O,k,A=e((()=>{D=t(n(),1),m(),g(),p(),o(),r(),S(),O=l(),k=[],E.displayName=`CheckboxList`,E.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function j({label:e,"aria-label":t,value:n,description:r,endContent:i,isDisabled:a=!1,isLoading:o=!1,isChecked:c,onCheck:l,ref:u,xstyle:f,className:p,style:m,onClick:h,...g}){let _=s(),b=(0,M.use)(w);if(b&&b.value!==void 0&&n===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let x=t??(typeof e==`string`?e:_(`@astryx.checkboxList.item.checkbox`));d(`CheckboxListItem`,'`label` is a ReactNode, so the checkbox falls back to the generic accessible name "Checkbox". Pass `aria-label` with a concise string equivalent of the visible label so screen readers can tell items apart.',typeof e!=`string`&&t==null);let S=((0,M.use)(y)?.density??`balanced`)===`compact`?`sm`:`md`,C=(b?.isDisabled??!1)||a,E=b?.isReadOnly??!1,D=o||(b?.loadingValue!=null&&n!==void 0?b.loadingValue===n:!1),O=!1;b&&b.value!==void 0&&n!==void 0?O=b.value.includes(n):c!==void 0&&(O=c);let k=!E&&(b!=null||l!=null),A=(0,M.useRef)(null),j=k||h!=null,F=()=>{C||E||D||(b&&b.value!==void 0&&n!==void 0?b.value.includes(n)?b.onChange?.(b.value.filter(e=>e!==n),n):b.onChange?.([...b.value,n],n):l?.(O!==!0))};return(0,N.jsx)(v,{...g,ref:u,label:e,description:r,endContent:i,isDisabled:C,interactiveRef:j?A:void 0,"aria-busy":D||void 0,xstyle:[O===!0&&!C&&!E&&P.selected,f],className:p,style:m,startContent:(0,N.jsx)(T,{ref:A,label:x,isLabelHidden:!0,value:O,onChange:()=>F(),onClick:h,isDisabled:C,isReadOnly:E,isLoading:D,size:S})})}var M,N,P,F=e((()=>{M=t(n(),1),f(),C(),b(),x(),S(),c(),N=l(),P={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},j.displayName=`CheckboxListItem`,j.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
