import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{t as r}from"./react-B7Te67-h.js";import{t as i}from"./jsx-runtime-DqZldVDK.js";import{n as a,t as o}from"./useIsomorphicLayoutEffect-AEBSTB0m.js";import{n as s,t as c}from"./useTooltip-BV-_h7Vm.js";var l=e({Tooltip:()=>f});function u(e){return typeof e==`string`||typeof e==`number`}function d(...e){let t=e.filter(Boolean);return t.length>0?t.join(` `):void 0}function f({children:e,anchorRef:t,content:n,placement:r=`above`,alignment:i=`center`,delay:o=200,hideDelay:c=0,focusTrigger:l=`auto`,touchTrigger:f=`auto`,isEnabled:h=!0,onOpenChange:g,hasHoverIndication:_=`auto`,isOpen:v,isDefaultOpen:y}){let b=(0,p.useRef)(null),x=e==null?!1:u(e),S=_===!0||_===`auto`&&x,C=s({placement:r,alignment:i,delay:o,hideDelay:c,focusTrigger:l,touchTrigger:f,isEnabled:h,isOpen:v,isDefaultOpen:y,onShow:(0,p.useCallback)(()=>{g?.(!0)},[g]),onHide:(0,p.useCallback)(()=>{g?.(!1)},[g])});return a(()=>{if(!t)return;let e=t.current;if(!e)return;C.ref(e);let n=e.getAttribute(`aria-describedby`);return e.setAttribute(`aria-describedby`,d(n,C.describedBy)??``),()=>{C.ref(null),n?e.setAttribute(`aria-describedby`,n):e.removeAttribute(`aria-describedby`)}},[t,C.ref,C.describedBy]),a(()=>{if(t||x)return;let e=b.current;if(!e)return;let n=e.firstElementChild;if(!n)return;C.ref(n);let r=n.getAttribute(`aria-describedby`);return n.setAttribute(`aria-describedby`,d(r,C.describedBy)??``),()=>{C.ref(null),r?n.setAttribute(`aria-describedby`,r):n.removeAttribute(`aria-describedby`)}},[t,x,C.ref,C.describedBy]),t&&e==null?(0,m.jsx)(m.Fragment,{children:C.renderTooltip(n)}):x?(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`span`,{ref:C.ref,tabIndex:0,"aria-describedby":C.describedBy,...{0:{className:`astryxt0psk2`},1:{className:`astryxt0psk2 astryxujl8zx astryxev0dqp astryxycaml9 astryxrys4gj`}}[!!S<<0],children:e}),C.renderTooltip(n)]}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`div`,{ref:b,className:`astryxjp7ctv`,children:e}),C.renderTooltip(n)]})}var p,m,h=t((()=>{p=n(r(),1),o(),c(),m=i(),f.displayName=`Tooltip`,f.__docgenInfo={description:`Tooltip component for displaying informative text on hover/focus.
