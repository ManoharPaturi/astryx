    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: 'npx shadcn@latest add https://astryx.atmeta.com/r/astryx-component-button.json',
        },
        {
          type: 'code',
          lang: 'bash',
          label: 'Install the editable Button showcase',
          code: 'npx shadcn@latest add https://astryx.atmeta.com/r/astryx-showcase-button-showcase.json',
        },
        {
          type: 'code',
          lang: 'bash',
          label: 'Install the complete dashboard page',
          code: 'npx shadcn@latest add https://astryx.atmeta.com/r/astryx-page-dashboard.json',
        },
      ],
    },
    {
