...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Pass `enabled` so hook only runs for the case that scrolls (fixed height, max-height, overflow prop).' },
